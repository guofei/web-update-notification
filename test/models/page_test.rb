...
class PageTest < ActiveSupport::TestCase
  ...
  test 'sec 1minute, updated at 3 days ago' do
    page = Page.new(sec: 60, updated_at: 3.days.ago)
    assert_equal(1.hours.seconds, page.second)
  end

  test 'sec 1hours, updated at 40minutes ago' do
    page = Page.new(sec: 1.hours.seconds, updated_at: 40.minutes.ago)
    assert_equal(1.hours.seconds, page.second)
  end

  test 'sec 1hours, updated at 2hours ago' do
    page = Page.new(sec: 1.hours.seconds, updated_at: 2.hours.ago)
    assert_equal(1.hours.seconds, page.second)
  end

  test 'sec 1hours, updated at 3days ago' do
    page = Page.new(sec: 1.hours.seconds, updated_at: 3.days.ago)
  ...
  test 'sec 4hour, updated at 3 day ago' do
    page = Page.new(sec: 4.hours.seconds, updated_at: 3.days.ago)
